...
> = {
  ...
  "import-yapi-json": { label: "YApi JSON 导入", note: "项目设置 → 环境与数据" },
  "import-postman": { label: "Postman 导入", note: "项目设置 → 环境与数据" },
  "import-har": { label: "HAR 导入", note: "项目设置 → 环境与数据" },
  "import-swagger": { label: "Swagger 导入", note: "项目设置 → 环境与数据" },
