...
import {
  ...
  updateGroupList,
  deleteGroup
} from "@/store/slices/group.js";
import { trim } from "@/utils/common.mjs";
//
...
class GroupSetting extends Component {
  ...
  editGroup = async() => {
    ...
    if (!res.payload.data.errcode) {
      ...
      const currGroup = _.find(this.props.groupList, (group) => +group._id === +id);
  ...
  showConfirm = () => {
    Modal.confirm({
      title: "确认删除 " + this.props.currGroup.group_name + " 分组吗？",
      content: (
      ...
      onOk() {
        ...
        if (this.props.currGroup.group_name !== groupName) {
        ...
        {this.props.curUserRole === "admin" ? (
          <Row type="flex" justify="center" className="danger-container">
            ...
            {this.state.showDangerOptions ? (
              <Card hoverable className="card-danger" style={{ width: "100%" }}>
